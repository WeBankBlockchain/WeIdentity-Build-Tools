<template>
  <section class="content section_main">
    <div class="box" style="width: 70%; margin-left: 200px">
      <div class="card card-primary warning_box">
        <div class="card-header card-title"><h3>区块链节点配置</h3></div>
        <div class="card-body">
          <el-form ref="form" label-position="right" :model="form" label-width="220px" inline-message="true">
          ...
          <div class="node_part">
            <el-button  type="primary" @click='nodeConfigUpload($event)' class="btn btn_150">完成</el-button>
          </div>
        </div>
      </div>
    </div>
